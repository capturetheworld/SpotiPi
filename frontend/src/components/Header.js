...
function Header({ spotifyApi, searchResults, setSearchResults, searchText, setSearchText, showKeyboard }) {
  ...
  return (
    <div className='head'>
      ...
      <Search className='search' setSearchText={setSearchText} showKeyboard={showKeyboard} />
      <Button
